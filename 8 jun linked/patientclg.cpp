...
class Node {
public:
    string patient;       // value in the node
    Node* next;     // pointer to next node

    // constructor to initialize a node
    Node(string pat) {
        patient = pat;  // store patient name
        next = NULL;    // next pointer initialized to NULL
...
void insertAtPosition(string pat, int pos) {
    ...
    if (pos == 1) {
        ...
        cout << "Inserted " << pat << " at position " << pos << endl;
        return;
    }
...
void deleteAtPosition(int pos) {
    ...
    if (pos == 1) {
        head = head->next;
        cout << "Deleted element: " << temp->patient<< endl;
        delete temp;
        return;
    }
    ...
    cout << "Deleted element: " << nodeToDelete->patient<< endl;
    delete nodeToDelete;
}
...
int main() {
    ...
    do {
        cout << "\nWhat to do\n";
        cout << "1. Insert at patient position\n";
        cout << "2. Delete at patient position\n";
        cout << "3. Display of patient list\n";
        cout << "4. Exit\n";
